...
const stateTracker = require('./helpers/document/stateTracker');
const validator = require('./helpers/document/validator');
...
Document.prototype.markModified = function(path, scope) {
  stateTracker.markModified(this, path, scope);
};
...
Document.prototype.unmarkModified = function(path) {
  stateTracker.unmarkModified(this, path);
};
...
Document.prototype.modifiedPaths = function(options) {
  return stateTracker.getModifiedPaths(this, options);
};
...
Document.prototype.isModified = function(paths, options, modifiedPaths) {
  return stateTracker.isModified(this, paths, options, modifiedPaths);
};
...
Document.prototype.isDirectModified = function(path) {
  return stateTracker.isDirectModified(this, path);
};
...
function _completeValidate(doc) {
  return validator.completeValidate(doc);
}
